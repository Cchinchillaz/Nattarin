...
function Story({ close, event }) {
    return (
        <div className="bg-black-300/90 border-2 border-white-800 rounded-xl w-[92vw] h-[70vh] sm:w-[72vw] sm:h-[62vh] lg:w-[42vw] lg:h-[62vh] p-0 self-center fixed top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 min-h-[320px]">
